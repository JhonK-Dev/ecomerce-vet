          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-2">
                <Badge variant={pet.gender.includes('neutered') || pet.gender.includes('spayed') ? 'secondary' : 'outline'}>
                  {gender}
                </Badge>
                {pet.microchipNumber && (
        ...
        {urgentAlerts.length > 0 && (
          <Alert className="border-orange-200 bg-orange-50">
            ...
            <AlertDescription className="text-orange-800">
              <strong>Atención:</strong> {urgentAlerts.length} alerta{urgentAlerts.length > 1 ? 's' : ''} próxima{urgentAlerts.length > 1 ? 's' : ''}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{pet.birthDate.toLocaleDateString()}</span>
              </div>
              {stats && (
                <div className="flex justify-between">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <span className="text-xs leading-relaxed">{pet.ownerAddress}</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{pet.emergencyContact.name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Teléfono:</span>
                  <span className="font-medium">{pet.emergencyContact.phone}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Relación:</span>
                  <span className="font-medium">{pet.emergencyContact.relationship}</span>
                </div>
              </div>
            </div>
          </>
